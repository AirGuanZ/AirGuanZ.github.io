...
**Start Vertex:** a vertex $v$ is a start vertex iff its two neighbors lie below it and the interior angle at $v$ is less that $\pi$.

**Split Vertex:** a vertex $v$ is a split vertex iff its two neighbors lie below it and the interior angle at $v$ is greater than $\pi$.

**End Vertex:** a vertex $v$ is an end vertex iff its two neighbors lie above it and the interior angle at $v$ is less than $\pi$.

**Merge Vertex:** a vertex $v$ is a merge vertex iff its two neighbors lie above it and the interior angle at $v$ is greater than $\pi$.
